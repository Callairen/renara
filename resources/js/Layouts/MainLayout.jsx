...
export default function MainLayout({ children }) {
    return (
        <div className="min-h-screen bg-black relative overflow-x-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex space-x-1 sm:space-x-4">
                            <Link 
                                href="/yours" 
                                className="text-white/80 hover:text-white hover:bg-white/10 px-3 py-2 rounded-lg text-sm font-medium transition duration-300"
                            >
                                Yours
                            </Link>
                            <Link 
                            ...
                            <Link 
                                ...
                                method="post" 
                                as="button" 
                                className="text-red-300 hover:text-red-100 hover:bg-red-500/20 px-3 py-2 rounded-lg text-sm font-medium transition duration-300"
                            >
                                Logout
                            </Link>
                        </div>
            ...
            {/* Area Konten Utama (padding-top agar tidak tertutup navbar) */}
